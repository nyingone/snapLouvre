 ...
 */
final class Version20191120180724 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE booking_order (id INT AUTO_INCREMENT NOT NULL, customer_id INT NOT NULL, order_number INT NOT NULL, order_date DATETIME NOT NULL, expected_date DATE NOT NULL, part_time_code SMALLINT NOT NULL, total_amount DOUBLE PRECISION NOT NULL, booking_ref VARCHAR(255) NOT NULL, validated_at DATETIME DEFAULT NULL, invoice_number INT DEFAULT NULL, payment_method VARCHAR(255) DEFAULT NULL, payment_number INT NOT NULL, payment_ext_ref VARCHAR(255) NOT NULL, cancelled_at DATETIME DEFAULT NULL, INDEX IDX_64556E2D9395C3F3 (customer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
